...
[![Live Your Life][blog-app-logo]](Images/blog-app-logo.png)

<code style="color:#7e3af2">Live Your Life</code> is a full-stack blog application that leverages principles of responsive and accessible web design. Made from scratch, the app was intented to be a learning tool for me to gain hands-on experience and acquire new skills and knowldge in the process of its developement. 

### Key Features Include

> :radio_button: **Read and Sort Articles**: Explore a wide range of articles by the website's users and sort them by 6 distinct categories.  

> :radio_button: **Join <code style="color:#7e3af2">Live Your Life</code>**: Create a personalized account. 

> :radio_button: **Publish, Edit & Delete Articles**: Write compelling articles and share them with the world. Enjoy complete control over your content with options to edit and delete articles as needed. 

[^1]: Check <a href="#usage">Usage</a></li> for detailed information. 
...
[^1]: Check <a href="#acknowledgments">Acknowledgments</a></li> for more information.
...
> ### Register Page
> <img align="center" src="./Images/live-your-life_register.png" height="400" />
...
> ### Login Page
> <img align="center" src="./Images/live-your-life_login.png" height="400" />
> - Enter your email address and password to log in.

> ### Main Page
> <img align="center" src="./Images/live-your-life_main-page.png" height="400" />
...
> <img align="center" src="./Images/live-your-life_edit-user-page.png" height="400" />
...
> ### Create Article Page
> <img align="center" src="./Images/live-your-life_create-article.png" height="400" />
...
> <img align="center" src="./Images/live-your-life_technology-articles.png" height="400" />
> - After successfully creating the article, you can view it among articles written by other users.

> ### Edit/Delete Article Page
> <img align="center" src="./Images/live-your-life_edit-article-page.png" height="400" />
...
> <img align="center" src="./Images/live-your-life_logout-page.png" height="400" />
> - Confirm your decision to log out of your account.


## Acknowledgments
 
> :radio_button: [![Preline][Preline UI]](https://preline.co/)
> :radio_button: [![React Router][React Router DOM]](https://reactrouter.com/en/main)
> :radio_button: [![Axios][Axios]](https://axios-http.com/)
> :radio_button: [![React Cookie][react-cookie]](https://www.npmjs.com/package/react-cookie)
> :radio_button: [![uuid][uuid]](https://www.npmjs.com/package/uuid)
> :radio_button: [![Bcrypt][bcrypt]](https://www.npmjs.com/package/bcrypt)
> :radio_button: [![JSON Web Token][jsonwebtoken]](https://www.npmjs.com/package/jsonwebtoken)
> :radio_button: [![Postgres.js][Postgres.js]](https://github.com/porsager/postgres)
> :radio_button: [![Nodemon][nodemon]](https://www.npmjs.com/package/nodemon)
